...
public class DBCountriesTable {
    ...
    @AfterTest//instead of closing the connection after any test case just put your uti method here. and because Aftermethod runs everytime at last
    ...
    public void columnNumber(){
        ...
        ResultSet resultSet= DatabaseUtil.runQuary("SLECT*FROM countries");

        int expectedNumberOfColumnCount= 3;// this is coming from ui, front-end
    ...
    public void columnName(){
        ...
        String expectedFirstColumnName= "COUNTRY_ID"; //this is info might coming from ui(@FindBy(element etc)
        ...
        Assert.assertEquals(actualFirstColumnName, expectedFirstColumnName,"First Column Name is Incorrect!");
